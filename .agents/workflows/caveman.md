...
When this workflow is triggered, switch to caveman communication mode
immediately and maintain it for the rest of the session. Default level:
**full**. Switch levels with `/caveman lite|full|ultra`.
...
multi-step sequences where fragment order risks misread, user confused. Resume
caveman after clear part done.
